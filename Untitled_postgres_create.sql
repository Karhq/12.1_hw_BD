CREATE TABLE "public.emp_name" (
	"emp_name_id" serial NOT NULL,
	"lastname_id" serial NOT NULL,
	"firstname_id" serial NOT NULL,
	"middlename_id_id" serial NOT NULL,
	CONSTRAINT "emp_name_pk" PRIMARY KEY ("emp_name_id")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.firstname_id" (
	"firstname_id" integer NOT NULL,
	"firstname_name" varchar(255) NOT NULL UNIQUE,
	CONSTRAINT "firstname_id_pk" PRIMARY KEY ("firstname_id")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.lastname_id" (
	"lastname_id" integer NOT NULL,
	"lastname_name" varchar(255) NOT NULL UNIQUE,
	CONSTRAINT "lastname_id_pk" PRIMARY KEY ("lastname_id")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.middlename_id" (
	"middlename_id" integer NOT NULL,
	"middlename_name" varchar(255) NOT NULL UNIQUE,
	CONSTRAINT "middlename_id_pk" PRIMARY KEY ("middlename_id")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.Branch_adress" (
	...
	CONSTRAINT "Branch_adress_pk" PRIMARY KEY ("branch_adr_id")
) WITH (
  OIDS=FALSE
);
...
CREATE TABLE "public.employee" (
	"emp_id" BINARY NOT NULL,
	"emp_salary" BINARY NOT NULL,
	"emp_branch_adress_id" integer NOT NULL,
	"emp_first_wd" DATE NOT NULL,
	"emp_name" serial NOT NULL,
...
CREATE TABLE "public.position_emp" (
	"emp_id" integer NOT NULL,
	"pos_id" BINARY NOT NULL
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "emp_name" ADD CONSTRAINT "emp_name_fk0" FOREIGN KEY ("emp_name_id") REFERENCES "employee"("emp_name");

ALTER TABLE "firstname_id" ADD CONSTRAINT "firstname_id_fk0" FOREIGN KEY ("firstname_id") REFERENCES "emp_name"("firstname_id");

ALTER TABLE "lastname_id" ADD CONSTRAINT "lastname_id_fk0" FOREIGN KEY ("lastname_id") REFERENCES "emp_name"("lastname_id");

ALTER TABLE "middlename_id" ADD CONSTRAINT "middlename_id_fk0" FOREIGN KEY ("middlename_id") REFERENCES "emp_name"("middlename_id_id");
...
ALTER TABLE "street" ADD CONSTRAINT "street_fk0" FOREIGN KEY ("street_id") REFERENCES "Branch_adress"("street_id");

ALTER TABLE "building" ADD CONSTRAINT "building_fk0" FOREIGN KEY ("building_id") REFERENCES "Branch_adress"("building_id");
...
ALTER TABLE "position_emp" ADD CONSTRAINT "position_emp_fk0" FOREIGN KEY ("emp_id") REFERENCES "employee"("emp_id");
ALTER TABLE "position_emp" ADD CONSTRAINT "position_emp_fk1" FOREIGN KEY ("pos_id") REFERENCES "position"("position_id");
