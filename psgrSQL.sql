...
CREATE TABLE "public.personal_name" (
	"emp_name_id" integer NOT NULL,
	"name" varchar(255) NOT NULL,
	"lastname" varchar(255) NOT NULL,
	"midlename" varchar(255) NOT NULL,
	CONSTRAINT "personal_name_pk" PRIMARY KEY ("emp_name_id")
) WITH (
  OIDS=FALSE
);
...
ALTER TABLE "personal_name" ADD CONSTRAINT "personal_name_fk0" FOREIGN KEY ("emp_name_id") REFERENCES "employee"("emp_name_id");
